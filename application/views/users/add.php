    ...
    <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" data-rule-remote="<?php echo url('users/check') ?>" data-msg-remote="<?php echo lang('user_username_take_id') ?>" name="username" id="formClient-Username" required placeholder="<?php echo lang('user_enter_idnumber') ?>" />
          </div>
