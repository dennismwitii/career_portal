    ...
    <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label for="formClient-Username"><?php echo lang('user_idnumber') ?></label>
            <input type="text" class="form-control" data-rule-remote="<?php echo url('users/check?notId='.$User->id) ?>" data-msg-remote="<?php echo lang('user_username_take_id') ?>" name="username" id="formClient-Username" required placeholder="<?php echo lang('user_enter_idnumber') ?>"  value="<?php echo $User->username ?>"/>
          </div>
