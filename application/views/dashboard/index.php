    ...
    <div class="row">
      ...
      <div class="col-md-2 col-sm-12">
        ...
        <div class="small-box bg-yellow">
          ...
          <a href="<?php echo base_url(); ?>candidates" class="small-box-footer">
      ...
      <div class="col-md-2 col-sm-12">
        ...
        <div class="small-box bg-primary">
          ...
          <a href="<?php echo base_url(); ?>job-board" class="small-box-footer">
            <?php echo lang('more_info'); ?> <i class="fa fa-arrow-circle-right"></i>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-2 col-sm-12">
        ...
        <div class="small-box bg-maroon">
          ...
          <a href="<?php echo base_url(); ?>candidate-interviews" class="small-box-footer">
            <?php echo lang('more_info'); ?> <i class="fa fa-arrow-circle-right"></i>
          </a>
        </div>
      </div>
      ...
      <section class="col-lg-6">
        ...
        <div class="box box-danger">
          <div class="box-header with-border">
            ...
            <div class="box-tools pull-right dashboard-jobs-tools">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            ...
            <div class="box-tools pull-right dashboard-jobs-list-tools">
      ...
      <section class="col-lg-6">
        ...
        <div class="box box-warning">
          <div class="box-header">
            ...
            <div class="box-tools pull-right dashboard-todos-tools">
...
<?php include(VIEW_ROOT.'/layout/footer.php'); ?>
