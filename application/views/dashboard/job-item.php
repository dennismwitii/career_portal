...
<tr>
  <td>
    <a href="<?php echo base_url(); ?>jobs/create-or-edit/<?php echo esc_output($job['job_id']); ?>">
      <?php echo esc_output($job['title'], 'html'); ?>
    </a>
    <a href="<?php echo base_url(); ?>job-board/<?php echo esc_output($job['job_id']); ?>" target="_blank">
